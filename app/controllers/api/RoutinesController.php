...
class RoutinesController extends BaseController
{
    ...
    public function show($id)
    {
        ...
        return ($routine) ? $routine->toArray() : Response::apiError(Lang::get('routine.not_found'), 404);
    }
    ...
    {
        $routine = $this->routineRepository->whereId($id)->whereUserId($this->user->id)->first();

        $routine->delete();

        return Response::json(['message' => 'Routine deleted.'], 204);
    }
